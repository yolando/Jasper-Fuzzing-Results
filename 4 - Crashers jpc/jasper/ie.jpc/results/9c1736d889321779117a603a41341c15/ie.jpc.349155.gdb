...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              786432, 3085720544, 134515036, 3221222172, 1175, 3221222140, 
              134513628, 3085212104, 3221221984, 4, 3221222068, 3086013371, 
              3087005944, 3085456116, 3086532596, 14, 3221223528, 3221222188, 
              3086131524, 91, 3221222068, 4, 0, 3221222164, 3221222176, 2, 
              3086399434, 3086399430, 3086394980, 3086395006, 230, 
              3221222068}}, sa_flags = -1073745156, sa_restorer = 0xb7f6cb5b}
...
#6  0xb7eb5af5 in _int_free (av=<value optimized out>, p=0x8136a28)
    at malloc.c:5018
        size = 95704
        nextchunk = 0x74e9
        nextsize = 86312
        ...
        __func__ = "_int_free"
#7  0xb7eb8c5d in *__GI___libc_free (mem=0x8138e98) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x6
#8  0x08086134 in jas_free (ptr=0x8138e98) at jas_malloc.c:111
No locals.
#9  0x080731c6 in jpc_qcx_destroycompparms (compparms=0x80af4f0)
    at jpc_cs.c:954
No locals.
#10 0x08072f4e in jpc_qcc_destroyparms (ms=0x80af4e0) at jpc_cs.c:891
        qcc = 0x80af4ec
...
#15 0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317840488, tv_usec = 275593}, stop = {
...
edx            0x6	6
ebx            0x74e9	29929
esp            0xbffff1ec	0xbffff1ec
ebp            0xbffff204	0xbffff204
esi            0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 29929] will be killed.
