...
*__GI___libc_free (mem=0x1800) at malloc.c:3710
	in malloc.c
#0  *__GI___libc_free (mem=0x1800) at malloc.c:3710
        ar_ptr = <value optimized out>
        p = 0x17f8
#1  0x08086134 in jas_free (ptr=0x1800) at jas_malloc.c:111
No locals.
#2  0x08079b20 in jpc_dec_cp_destroy (cp=0x80b15b0) at jpc_dec.c:1557
No locals.
#3  0x0807a8f6 in jpc_dec_destroy (dec=0x80af470) at jpc_dec.c:1894
No locals.
#4  0x08076332 in jpc_decode (in=0x80ab308, optstr=0x0) at jpc_dec.c:285
...
#6  0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317837153, tv_usec = 225711}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 17357] will be killed.
