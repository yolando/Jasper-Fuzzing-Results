...
0x0807a1b0 in jpc_dec_cp_setfromqcx (cp=0x80b15b0, ccp=0x80b15d0, 
    compparms=0x80b18ec, flags=0) at jpc_dec.c:1704
	in jpc_dec.c
#0  0x0807a1b0 in jpc_dec_cp_setfromqcx (cp=0x80b15b0, ccp=0x80b15d0, 
    compparms=0x80b18ec, flags=0) at jpc_dec.c:1704
        bandno = 198
#1  0x0807a0f3 in jpc_dec_cp_setfromqcd (cp=0x80b15b0, qcd=0x80b18ec)
    at jpc_dec.c:1682
        compno = 0
        ccp = 0x80b15d0
#2  0x08079511 in jpc_dec_process_qcd (dec=0x80af470, ms=0x80b18e0)
    at jpc_dec.c:1338
        qcd = 0x80b18ec
        tile = 0x80a09c0
...
#6  0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317836111, tv_usec = 674773}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 26698] will be killed.
