...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {sa_handler = 0xbffffaa0, 
            sa_sigaction = 0xbffffaa0}, sa_mask = {__val = {3087006384, 
              3221224052, 3086926562, 3221224036, 134513660, 3221224024, 
              3087006292, 0, 3086681608, 1, 0, 1, 3087005944, 134766900, 
              3086532596, 0, 3221223960, 134766900, 134942088, 2016, 0, 
              3221224096, 3221224024, 3221224036, 3086537632, 3087005944, 0, 
              3085667421, 3086843521, 134515866, 3086532596, 0}}, 
          sa_flags = -1073743272, sa_restorer = 0x8086134 <jas_free+17>}
        sigs = {__val = {32, 0 <repeats 31 times>}}
#3  0x0807677f in jpc_dec_process_sot (dec=0x80af470, ms=0x80af4e0)
    at jpc_dec.c:478
        tile = 0x80afd38
        sot = 0x80af4ec
        compinfos = 0x80afd38
...
#7  0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317832077, tv_usec = 35226}, stop = {
...
edx            0x6	6
ebx            0xd9d	3485
esp            0xbffff988	0xbffff988
ebp            0xbffff9a0	0xbffff9a0
esi            0x0	0
...
A debugging session is active.
	...
	Inferior 1 [process 3485] will be killed.
