...
#7  0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317838263, tv_usec = 91376}, stop = {
        ...
        numcmpts = 134517192
        i = -1209563739
Dump of assembler code from 0xb7eb67da to 0xb7eb681a:
0xb7eb67da <_int_malloc+170>:	add    $0x38,%esi
...
eax            0x100000f0	268435696
ecx            0x40000000	1073741824
edx            0x68	104
ebx            0xb7f8bff4	-1208434700
esp            0xbffff9f8	0xbffff9f8
ebp            0xbffffa68	0xbffffa68
esi            0x10000098	268435608
edi            0x0	0
eip            0xb7eb67fa	0xb7eb67fa <_int_malloc+202>
...
A debugging session is active.
	...
	Inferior 1 [process 10185] will be killed.
