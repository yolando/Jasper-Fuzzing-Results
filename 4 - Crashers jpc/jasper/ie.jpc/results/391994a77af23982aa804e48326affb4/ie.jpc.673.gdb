...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              ...
              3086131524, 23, 3221222160, 4, 0, 3221222256, 3221222268, 2, 
...
#4  0xb7eb4321 in malloc_printerr (action=<value optimized out>, 
    str=0x6 <Address 0x6 out of bounds>, ptr=0x80afb08) at malloc.c:6267
        buf = "080afb08"
        cp = <value optimized out>
#5  0xb7eb5c63 in _int_free (av=<value optimized out>, p=0x80afb08)
    at malloc.c:4948
        size = 1208
        ...
        __func__ = "_int_free"
#6  0xb7eb8c5d in *__GI___libc_free (mem=0x80aff80) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x6
#7  0x08086134 in jas_free (ptr=0x80aff80) at jas_malloc.c:111
No locals.
...
#14 0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317832066, tv_usec = 580791}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 2948] will be killed.
