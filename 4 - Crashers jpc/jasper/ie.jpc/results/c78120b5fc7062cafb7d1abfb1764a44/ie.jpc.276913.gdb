...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              786432, 3085720544, 134515036, 3221222120, 1175, 3221222088, 
              134513628, 3085212104, 3221221932, 4, 3221222016, 3086013371, 
              3087005944, 3085456116, 3086532596, 14, 3221223476, 3221222136, 
              3086131524, 87, 3221222016, 4, 0, 3221222112, 3221222124, 2, 
              3086399434, 3086399430, 3086394980, 3086395006, 230, 
              3221222016}}, sa_flags = -1073745208, sa_restorer = 0xb7f6cb5b}
...
#4  0xb7eb4321 in malloc_printerr (action=<value optimized out>, 
    str=0x6 <Address 0x6 out of bounds>, ptr=0x80b1598) at malloc.c:6267
        buf = "080b1598"
        cp = <value optimized out>
#5  0xb7eb477a in malloc_consolidate (av=<value optimized out>)
    at malloc.c:5153
        fb = 0xb7f8d3b0
        maxfb = 0xb7f8d3cc
        p = 0x80b1578
...
#6  0xb7eb688d in _int_malloc (av=<value optimized out>, 
...
#7  0xb7eb8d2c in *__GI___libc_malloc (bytes=8208) at malloc.c:3661
        ar_ptr = 0xb7f8d3a0
        victim = <value optimized out>
        __func__ = "__libc_malloc"
#8  0x08086121 in jas_malloc (size=8208) at jas_malloc.c:106
No locals.
#9  0x08052a19 in jas_stream_initbuf (stream=0xbb8c268, bufmode=2, buf=0x0, 
    bufsize=0) at jas_stream.c:708
        __PRETTY_FUNCTION__ = "jas_stream_initbuf"
#10 0x080517ac in jas_stream_memopen (buf=0x0, bufsize=0) at jas_stream.c:187
        stream = 0xbb8c268
        obj = 0xa
#11 0x080714bf in jpc_getms (in=0x80ab308, cstate=0x80af460) at jpc_cs.c:269
        ms = 0x80af4e0
        mstabent = 0x80a0918
        tmpstream = 0xbb8c268
#12 0x080764c8 in jpc_dec_decode (dec=0x80af470) at jpc_dec.c:372
        ms = 0x80af4e0
        mstabent = 0x80a0b4c
        ret = 0
        cstate = 0x80af460
...
#14 0x0804ad04 in jas_image_decode (in=0x80ab308, fmt=5, optstr=0x0)
    at jas_image.c:372
        fmtinfo = 0x80a25c4
        image = 0x0
#15 0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        image = 0xb7f8bff4
        cmdopts = 0x80a92d0
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317838877, tv_usec = 715516}, stop = {
