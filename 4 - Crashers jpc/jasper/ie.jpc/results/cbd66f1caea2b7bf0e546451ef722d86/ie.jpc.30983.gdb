...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              786432, 3085720544, 134515036, 3221222264, 1175, 3221222232, 
              134513628, 3085212104, 3221222076, 4, 3221222160, 3086013371, 
              3087005944, 3085456116, 3086532596, 13, 3221223620, 3221222280, 
              3086131524, 49, 3221222160, 4, 0, 3221222256, 3221222268, 2, 
              3086399434, 3086399430, 3086394980, 3086395006, 230, 
              3221222160}}, sa_flags = -1073745064, sa_restorer = 0xb7f6cb5b}
...
#4  0xb7eb4321 in malloc_printerr (action=<value optimized out>, 
    str=0x6 <Address 0x6 out of bounds>, ptr=0x80affe0) at malloc.c:6267
        buf = "080affe0"
        cp = <value optimized out>
#5  0xb7eb5bd1 in _int_free (av=<value optimized out>, p=0x80aff98)
    at malloc.c:4957
        size = 72
        nextchunk = 0x5534
        nextsize = 5576
        ...
        __func__ = "_int_free"
#6  0xb7eb8c5d in *__GI___libc_free (mem=0x80affa0) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x6
#7  0x08086134 in jas_free (ptr=0x80affa0) at jas_malloc.c:111
No locals.
#8  0x080731c6 in jpc_qcx_destroycompparms (compparms=0x80af4f0)
    at jpc_cs.c:954
No locals.
#9  0x08072f4e in jpc_qcc_destroyparms (ms=0x80af4e0) at jpc_cs.c:891
        qcc = 0x80af4ec
#10 0x08071864 in jpc_ms_destroy (ms=0x80af4e0) at jpc_cs.c:397
No locals.
#11 0x08076587 in jpc_dec_decode (dec=0x80af470) at jpc_dec.c:397
        ms = 0x80af4e0
        mstabent = 0x80a0b4c
        ret = 0
        cstate = 0x80af460
...
#12 0x08076280 in jpc_decode (in=0x80ab308, optstr=0x0) at jpc_dec.c:254
        ...
        dec = 0x80af470
        image = 0x0
#13 0x0804ad04 in jas_image_decode (in=0x80ab308, fmt=5, optstr=0x0)
    at jas_image.c:372
        fmtinfo = 0x80a25c4
        image = 0x0
#14 0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317833042, tv_usec = 747958}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 21812] will be killed.
