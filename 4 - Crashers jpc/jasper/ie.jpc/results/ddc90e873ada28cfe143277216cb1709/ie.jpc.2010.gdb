...
0xb7eb59ac in _int_free (av=<value optimized out>, p=0x80b15c8)
    at malloc.c:4957
	in malloc.c
#0  0xb7eb59ac in _int_free (av=<value optimized out>, p=0x80b15c8)
    at malloc.c:4957
        size = 496
        nextchunk = 0x80b17b8
        nextsize = 16
        ...
        __func__ = "_int_free"
#1  0xb7eb8c5d in *__GI___libc_free (mem=0x80b15d0) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x0
#2  0x08086134 in jas_free (ptr=0x80b15d0) at jas_malloc.c:111
No locals.
#3  0x08079b20 in jpc_dec_cp_destroy (cp=0x80b15b0) at jpc_dec.c:1557
No locals.
...
#7  0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317832152, tv_usec = 692797}, stop = {
...
ebp            0xbffffac0	0xbffffac0
esi            0x80b15c8	134944200
edi            0x1f0	496
...
A debugging session is active.
	...
	Inferior 1 [process 5481] will be killed.
