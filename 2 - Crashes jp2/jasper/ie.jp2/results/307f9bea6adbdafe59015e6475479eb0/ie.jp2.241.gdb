...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              ...
              3086131524, 12, 3221221936, 4, 0, 3221222032, 3221222044, 2, 
...
#4  0xb7eb4321 in malloc_printerr (action=<value optimized out>, 
    str=0x6 <Address 0x6 out of bounds>, ptr=0x80b0238) at malloc.c:6267
        buf = "080b0238"
        cp = <value optimized out>
#5  0xb7eb5b78 in _int_free (av=<value optimized out>, p=<value optimized out>)
    at malloc.c:4795
        ...
        __func__ = "_int_free"
#6  0xb7eb8c5d in *__GI___libc_free (mem=0x80b0238) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x6
#7  0x08086134 in jas_free (ptr=0x80b0238) at jas_malloc.c:111
No locals.
#8  0x080731c6 in jpc_qcx_destroycompparms (compparms=0x80b16c0)
    at jpc_cs.c:954
No locals.
#9  0x08072f4e in jpc_qcc_destroyparms (ms=0x80b16b0) at jpc_cs.c:891
        qcc = 0x80b16bc
#10 0x08071864 in jpc_ms_destroy (ms=0x80b16b0) at jpc_cs.c:397
No locals.
...
#15 0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317693265, tv_usec = 773649}, stop = {
