...
0x0807a1b0 in jpc_dec_cp_setfromqcx (cp=0x80b1488, ccp=0x80af840, 
    compparms=0x80b16c0, flags=8) at jpc_dec.c:1704
	in jpc_dec.c
#0  0x0807a1b0 in jpc_dec_cp_setfromqcx (cp=0x80b1488, ccp=0x80af840, 
    compparms=0x80b16c0, flags=8) at jpc_dec.c:1704
        bandno = 1951
#1  0x0807a162 in jpc_dec_cp_setfromqcc (cp=0x80b1488, qcc=0x80b16bc)
    at jpc_dec.c:1690
No locals.
#2  0x080795b8 in jpc_dec_process_qcc (dec=0x80b1620, ms=0x80b16b0)
    at jpc_dec.c:1364
        qcc = 0x80b16bc
        tile = 0x80a09d8
...
#7  0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317693431, tv_usec = 888962}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 16307] will be killed.
