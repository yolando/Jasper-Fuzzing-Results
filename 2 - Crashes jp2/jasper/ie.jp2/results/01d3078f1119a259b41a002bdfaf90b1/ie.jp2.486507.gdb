...
0xb7eb59ac in _int_free (av=<value optimized out>, p=0x80b16a8)
    at malloc.c:4957
	in malloc.c
#0  0xb7eb59ac in _int_free (av=<value optimized out>, p=0x80b16a8)
    at malloc.c:4957
        size = 112
        nextchunk = 0x80b1718
        nextsize = 496
        ...
        __func__ = "_int_free"
#1  0xb7eb8c5d in *__GI___libc_free (mem=0x80b16b0) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x3
#2  0x08086134 in jas_free (ptr=0x80b16b0) at jas_malloc.c:111
No locals.
#3  0x0807186f in jpc_ms_destroy (ms=0x80b16b0) at jpc_cs.c:399
No locals.
#4  0x08076587 in jpc_dec_decode (dec=0x80b1620) at jpc_dec.c:397
        ms = 0x80b16b0
        mstabent = 0x80a0b40
        ret = 0
        cstate = 0x80b1610
...
#8  0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317700088, tv_usec = 777744}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 28292] will be killed.
