...
#0  0x080863f0 in jas_matrix_create (numrows=33554464, numcols=32)
    at jas_seq.c:137
        matrix = 0x80b1038
        i = 18818
#1  0x0808625d in jas_seq2d_create (xstart=0, ystart=0, xend=32, yend=33554464)
    at jas_seq.c:90
        matrix = 0x0
        __PRETTY_FUNCTION__ = "jas_seq2d_create"
#2  0x08076f36 in jpc_dec_tileinit (dec=0x80b1620, tile=0x80b1788)
    at jpc_dec.c:699
        tcomp = 0x80b1870
        compno = 0
        rlvlno = 134875848
        ...
        bnds = {{xstart = 0, ystart = 0, xend = 0, yend = 0, orient = 0, 
            ...
            ystart = 0, xend = 0, yend = 0, orient = 0, locxstart = -72515580, 
            locystart = 0, locxend = 0, locyend = 0, 
            synenergywt = -1073753504}, {xstart = -1073753408, 
            ystart = -1073745312, xend = 0, yend = 0, orient = 0, 
            locxstart = 0, locystart = 0, locxend = 0, locyend = 0, 
            ...
            synenergywt = -1208434700}, {xstart = -1073743948, 
            ystart = -1208123392, xend = 97, yend = -1208433312, orient = 0, 
            locxstart = 0, locystart = 0, locxend = -1209436400, 
            locyend = -1208433312, synenergywt = -72515580}, {xstart = 0, 
            ystart = -1208434700, xend = -1208433312, yend = 0, 
            orient = -1073743688, locxstart = -1209508077, 
            ...
            locystart = -1073744224, locxend = -1208053403, locyend = 45, 
            ...
            synenergywt = -1073744132}, {xstart = 45, ystart = -1073743640, 
            ...
            locystart = 1718773110, locxend = -1208429608, 
            locyend = 1830841961, synenergywt = 1769237621}, {xstart = 9, 
            ystart = -1208428840, xend = -1209309378, yend = 9, orient = 1027, 
            locxstart = 8232, locystart = -1208429608, locxend = 107, 
            locyend = 8208, synenergywt = -1208428840}, {xstart = -1208429608, 
            ystart = 0, xend = 134559709, yend = 134940991, 
            orient = 134961648, locxstart = 1, locystart = 1024, 
            locxend = -1208568554, locyend = -1208429608, 
            synenergywt = -1208568830}, {xstart = 1, ystart = 1, 
            xend = -1209309378, yend = 134939936, orient = 2880, 
            locxstart = -1208429664, locystart = 3912, locxend = -1073743656, 
            locyend = 134557190, synenergywt = 134939936}, {
            ...
            xend = -1209299668, yend = -1208428856, orient = -1209309378, 
            locxstart = 0, locystart = 0, locxend = 0, locyend = 0, 
...
#3  0x080769d4 in jpc_dec_process_sod (dec=0x80b1620, ms=0x80b16b0)
    at jpc_dec.c:556
        tile = 0x80b1788
        pos = 134944432
...
#8  0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317693498, tv_usec = 408290}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 23448] will be killed.
