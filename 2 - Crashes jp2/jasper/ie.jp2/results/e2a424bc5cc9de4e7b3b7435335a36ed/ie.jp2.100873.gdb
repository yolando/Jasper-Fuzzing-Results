...
#2  0xb7e76b82 in *__GI_abort () at abort.c:92
        act = {__sigaction_handler = {
            ...
            sa_sigaction = 0xb7fff4e4 <_rtld_local+1220>}, sa_mask = {__val = {
              786432, 3085720544, 134515036, 3221221948, 1175, 3221221916, 
              134513628, 3085212104, 3221221760, 4, 3221221844, 3086013371, 
              3087005944, 3085456116, 3086532596, 15, 3221223304, 3221221964, 
              3086131524, 57, 3221221844, 4, 0, 3221221940, 3221221952, 2, 
              3086399434, 3086399430, 3086394980, 3086395006, 230, 
              3221221844}}, sa_flags = -1073745380, sa_restorer = 0xb7f6cb5b}
...
#4  0xb7eb4321 in malloc_printerr (action=<value optimized out>, 
    str=0x6 <Address 0x6 out of bounds>, ptr=0xe8afe08) at malloc.c:6267
        buf = "0e8afe08"
        cp = <value optimized out>
...
#6  0xb7eb5af5 in _int_free (av=<value optimized out>, p=0xe8b1e40)
    at malloc.c:5018
        size = 123328
        nextchunk = 0x3d6c
        nextsize = 110960
        ...
        __func__ = "_int_free"
#7  0xb7eb8c5d in *__GI___libc_free (mem=0xe8b2e50) at malloc.c:3739
        ar_ptr = 0xb7f8d3a0
        p = 0x6
#8  0x08086134 in jas_free (ptr=0xe8b2e50) at jas_malloc.c:111
No locals.
#9  0x080731c6 in jpc_qcx_destroycompparms (compparms=0x80b16c0)
    at jpc_cs.c:954
No locals.
#10 0x08072f4e in jpc_qcc_destroyparms (ms=0x80b16b0) at jpc_cs.c:891
        qcc = 0x80b16bc
#11 0x08071864 in jpc_ms_destroy (ms=0x80b16b0) at jpc_cs.c:397
No locals.
#12 0x08076587 in jpc_dec_decode (dec=0x80b1620) at jpc_dec.c:397
        ms = 0x80b16b0
        mstabent = 0x80a0b4c
        ret = 0
        cstate = 0x80b1610
...
#13 0x08076280 in jpc_decode (in=0x80ab308, optstr=0x0) at jpc_dec.c:254
        ...
        dec = 0x80b1620
        image = 0x80b15f8
#14 0x0805ba2f in jp2_decode (in=0x80ab308, optstr=0x0) at jp2_dec.c:215
        box = 0x0
        found = 1
        image = 0x0
        dec = 0x80af448
        ...
        lutents = 0xb7ffeff4
        cmapent = 0x8048d45
        icchdr = {size = 1, cmmtype = 0, version = 3221224272, 
          clas = 3221224200, colorspc = 3221224212, refcolorspc = 3221224232, 
          ctime = {year = 3087005944, month = 0, day = 0, hour = 8, 
            min = 134516037, sec = 134919058}, magic = 0, platform = 0, 
          flags = 3221224232, maker = 3086843772, model = 134553704, 
          attr = 34359738368, intent = 0, illum = {x = 0, y = -1209715468, 
            z = -1208286544}, creator = 134919058}
        iccprof = 0xb7fffab0
        __PRETTY_FUNCTION__ = "jp2_decode"
#15 0x0804ad04 in jas_image_decode (in=0x80ab308, fmt=4, optstr=0x0)
    at jas_image.c:372
        fmtinfo = 0x80a25a8
        image = 0x0
#16 0x08049a8c in main (argc=7, argv=0xbffffcc4) at jasper.c:229
        image = 0xb7f8bff4
        cmdopts = 0x80a92d0
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317694660, tv_usec = 981375}, stop = {
...
A debugging session is active.
	...
	Inferior 1 [process 15724] will be killed.
