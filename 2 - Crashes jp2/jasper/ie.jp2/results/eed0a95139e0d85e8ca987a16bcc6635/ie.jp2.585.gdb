...
No locals.
#3  0x080731c6 in jpc_qcx_destroycompparms (compparms=0x80b16bc)
    at jpc_cs.c:954
No locals.
#4  0x08072deb in jpc_qcd_destroyparms (ms=0x80b16b0) at jpc_cs.c:855
        qcd = 0x80b16bc
...
#10 0x08049a8c in main (argc=7, argv=0xbffffcd4) at jasper.c:229
        ...
        in = 0x80ab308
        out = 0x80ad390
        dectmr = {start = {tv_sec = 1317693279, tv_usec = 590375}, stop = {
